            ...
            <>
              <SignIn.Step name="start">
                <Card className="w-full sm:w-96">
                  <CardHeader>
                    <CardTitle>Sign in to ResumAI</CardTitle>
                    <CardDescription>
                            ...
                            <Clerk.Input
                              ...
                              render={({ value, status }) => (
                                <div
                                  data-status={status}
                                  className={cn(
                                    "first:border-1 relative flex size-10 items-center justify-center border-y border-r border-input text-sm transition-all first:rounded-l-md last:rounded-r-md",
                                    {
